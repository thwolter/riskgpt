from typing import Annotated, Any, List, TypedDict, TypeVar
...
from riskgpt.models.workflows.risk_analysis import RiskAnalysisResponse
...
def assign_response(existing: Any | None, new: Any) -> Any:
    """Assign a new value, replacing the existing one."""
    return new
...
class RiskAnalysisState(TypedDict):
    ...
    keypoint_text_response: Annotated[KeyPointSummaryResponse, assign_response]
    response: Annotated[RiskAnalysisResponse, assign_response]
