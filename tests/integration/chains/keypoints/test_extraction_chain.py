...
def create_response_info(prompt_name, error: Optional[str] = None):
    """Helper function to create a ResponseInfo object."""
...
class TestExtractionChain:
    ...
    including news and academic sources, with various citation scenarios.
    """
    ...
    async def test_extract_key_points_by_scope(
        ...
        mock_response = ExtractKeyPointsResponse(
            ...
            response_info=create_response_info(expected_prompt_name),
        )
    ...
    async def test_extract_key_points_with_focus_keywords(
        self, mock_chain, complete_citation, configure_test_logging
    ):
        ...
        mock_response = ExtractKeyPointsResponse(
            ...
            response_info=create_response_info("extract_news_key_points"),
        )
